...
import { handleSignUpOrLoginWithGithub } from "../utils/handleSignupOrLoginWithGithub";
        ...
        <div className='flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0'>
            <div className='w-full rounded-lg shadow bg-glass md:mt-0 sm:max-w-md xl:p-0'>
                <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
                    <h1 className='text-xl font-bold text-center md:text-2xl'>Create Account</h1>
                    <button
                        type='button'
                        ...
                        onClick={handleSignUpOrLoginWithGithub}
                    >
                    ...
                    <p className='text-sm font-light text-gray-500'>
                        ...
                        <Link to='/login' className='font-medium text-blue-600 text-primary-600 hover:underline'>
                            Login
                        </Link>
                    </p>
                </div>
